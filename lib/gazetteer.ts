...
export const UKRAINIAN_GAZETTEER: GeoLocation[] = [
    ...
    // --- КИЇВ ТА СТОЛИЧНИЙ РЕГІОН ---
  {
    ...
    aliases: [
      ...
      "хрещатик", "крещатик", "майдан", "печерськ", "печерск", "печерський", "печерском", "печерському",
      "липки", "звіринець", "арсенальна", "палац спорту", "палац україна", "центр києва", "центрі києва"
    ],
    lat: 50.4501,
    lng: 30.5234,
    type: 'city',
  ...
  },
  {
    ...
    aliases: [
      "оболонь", "оболони", "оболоні", "оболонський", "оболонский", "оболонському", "оболонськом",
      "мінський масив", "минский массив", "пріорка", "приорка", "куренівка", "куреневка", "куренівці",
      "пуща-водиця", "пуща водиця", "пуща водица", "північний міст київ", "оболонська набережна"
    ],
    lat: 50.5015,
    lng: 30.4981,
    type: 'microdistrict',
  ...
  },
  {
    ...
    aliases: [
      "поділ", "подол", "подолі", "подоле", "подільський", "подольский", "подільському",
      "лук'янівка", "лукянівка", "лукьяновка", "лук'янівці", "татарка", "татарці", "контрактова",
      "вітрогон", "дорогожичі", "дорогожичи", "сирець", "сырец"
    ],
    lat: 50.4680,
    lng: 30.5100,
    type: 'microdistrict',
  ...
  },
  {
    ...
    aliases: [
      "позняки", "позняках", "позняків", "осокорки", "осокорках", "осокорків", "славутич",
      "дарниця", "дарница", "дарниці", "дарницю", "дарницький", "дарницкий", "дарницькому",
      "харківський масив", "харьковский массив", "харківська площа", "бортничі", "бортничи", "бортничах",
      "червоний хутір", "красный хутор", "лівий берег київ", "левый берег киев"
    ],
    lat: 50.3980,
    lng: 30.6340,
    type: 'microdistrict',
  ...
  },
  {
    ...
    aliases: [
      "троєщина", "троещина", "троєщині", "троещине", "деснянський", "деснянский", "деснянському",
      "лісовий масив", "лесной массив", "лісовому", "лісова", "чернігівська київ", "биківня", "быковня",
      "радужний київ", "райдужний київ"
    ],
    lat: 50.5100,
    lng: 30.5900,
    type: 'microdistrict',
  ...
  },
  {
    ...
    aliases: [
      "дніпровський район київ", "днепровский район киев", "русанівка", "русановка", "русанівці",
      "березняки", "березняках", "воскресенка", "воскресенці", "лівобережна", "левобережная",
      "дврз", "соцмісто київ", "стара дарниця"
    ],
    lat: 50.4450,
    lng: 30.5950,
    type: 'microdistrict',
  ...
  },
  {
    ...
    aliases: [
      "святошин", "святошині", "святошине", "святошинський", "святошинский", "святошинському",
      "нивки", "нивках", "академмістечко", "академгородок", "академці", "житомирська",
      "борщагівка", "борщаговка", "борщагівці", "софіївська борщагівка", "петропавлівська борщагівка",
      "коцюбинське", "святопетрівське", "біличі", "новобіличі"
    ],
    lat: 50.4580,
    lng: 30.3720,
    type: 'microdistrict',
  ...
  },
  {
    ...
    aliases: [
      "солом'янка", "соломянка", "соломенка", "солом'янці", "солом'янський", "соломянский", "солом'янському",
      "жуляни", "жуляны", "жулянах", "севастопольська площа", "караваєві дачі", "кардачі",
      "шулявка", "шулявці", "шулявський", "політех", "кпі", "берестейська", "протасів яр", "протасов яр"
    ],
    lat: 50.4200,
    lng: 30.4700,
    type: 'microdistrict',
  ...
  },
  {
    ...
    aliases: [
      "голосіїв", "голосеево", "голосієві", "голосіївський", "голосеевский", "голосіївському",
      "теремки", "теремках", "вднг", "феофанія", "пирогово", "корчувате", "корчеватое",
      "чапаєвка", "лиса гора", "віта-литовська"
    ],
    lat: 50.3800,
    lng: 30.4900,
    type: 'microdistrict',
  ...
  },
  {
    ...
    aliases: [
      "вишгород", "вышгород", "вишгороді", "вишгородський", "вишгородському", "київська гес", "киевская гэс",
      "київське море", "киевское море", "київське водосховище", "нові петрівці", "новые петровцы",
      "старі петрівці", "хотянівка", "хотяновка", "лебедівка", "димер", "димері", "лютіж"
    ],
    lat: 50.5833,
    lng: 30.4833,
    type: 'town',
  ...
  },
  {
    ...
    aliases: [
      "бориспіль", "борисполь", "бориспільський", "бориспільському", "бориспільщині", "аеропорт бориспіль",
      "гора", "чубинське", "чубинское", "велика олександрівка", "щасливе", "проліски", "мартусівка",
      "іванків бориспільський", "глибоке", "вороньків"
    ],
    lat: 50.3500,
    lng: 30.9500,
    type: 'town',
  ...
  },
  {
    name: "Бровари",
    aliases: [
      "бровари", "бровары", "броварах", "броварський", "броварському", "броварщині",
      "велика димерка", "требухів", "требухов", "красилівка", "калинівка броварська",
      "зазим'я", "зазимье", "погреби", "погребы", "пухівка", "рожни", "літки", "княжичі броварські"
    ],
    lat: 50.5114,
    lng: 30.7903,
    type: 'town',
  ...
  },
  {
    ...
    aliases: [
      "ірпінь", "ирпень", "ірпені", "буча", "бучі", "бучанський", "бучанському",
      "гостомель", "гостомелі", "ворзель", "ворзелі", "немишаєве", "бородянка", "бородянці", "клавдієво"
    ],
    lat: 50.5200,
    lng: 30.2400,
    type: 'town',
  ...
  },
  {
    ...
    aliases: [
      "васильків", "васильков", "василькові", "васильківський", "васильківському", "аеродром васильків",
      "глеваха", "глевасі", "калинівка васильківська", "гребінки", "мархалівка", "іванковичі", "рославичі"
    ],
    lat: 50.1783,
    lng: 30.3167,
    type: 'town',
  ...
  },
  {
    ...
    aliases: [
      "обухів", "обухов", "обухові", "обухівський", "обухівському",
      "українка", "украинка", "українці", "трипілля", "триполье", "трипільська тес", "трипіллі",
      "козин", "козині", "козинський", "плити", "плюти", "халеп'я"
    ],
    lat: 50.1200,
    lng: 30.6300,
    type: 'town',
  ...
  },
  {
    name: "Боярка / Вишневе",
    aliases: [
      "боярка", "боярці", "боярки", "вишневе", "вишневое", "вишневому",
      "крюківщина", "крюковщина", "крюківщині", "тарасівка", "тарасовка", "гатне", "гатном"
    ],
    lat: 50.3200,
    lng: 30.3000,
    type: 'town',
  ...
  },
  {
    name: "Макарів / Фастів",
    aliases: [
      "макарів", "макаров", "макарові", "макарівський", "фастів", "фастов", "фастові", "фастівський",
      "бишів", "ясногородка", "калинівка фастівська", "мотовилівка"
    ],
    lat: 50.2500,
    lng: 29.8500,
    type: 'town',
  ...
  },
  {
    name: "Біла Церква",
    aliases: [
      "біла церква", "белая церковь", "білій церкві", "білоцерківський", "білоцерківському", "узин", "роresource", "володарка"
    ],
    lat: 49.7989,
    lng: 30.1153,
    type: 'city',
  ...
  },
  {
    ...
    aliases: [
      "переяслав", "переяславі", "переяслав-хмельницький", "яготин", "яготині", "яготинський",
      "баришівка", "барышевка", "березань", "березані", "занки"
    ],
    lat: 50.0650,
    lng: 31.4450,
    type: 'town',
